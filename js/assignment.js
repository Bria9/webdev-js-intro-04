...
function checkAgeAndRespond() {
    ...
    if( age >= 21){
        response.innerText = ("You can vote and purchase alcohol. ✅🍺");     
    }
    else if (age >= 18 && age < 21) {
      response.innerText = ("You can vote, but you cannot purchase alcohol ✅.");
      }
    else { response.innerText = ("You cannot vote and you cannot purchase alcohol. 🔞"); }  
